...
# 2. Hàng 2: ĐẶT 2 Ô CÙNG TRÊN 1 HÀNG (SGV bên Trái | Bài học bên Phải)
...
with col_b2_right:
    ...
    # Giữ nguyên toàn bộ logic đọc dữ liệu session_state của thầy
